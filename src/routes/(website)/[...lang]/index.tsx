            ...
            <div class="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                ...
                <p class="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
                  {t(
                    "home.hero.description@@Plan your perfect Maldives vacation with our easy-to-use trip planner. Explore top activities, find the best accommodations, and create a personalized itinerary.",
                  )}
                </p>
                <div class="mt-10 flex items-center gap-x-6">
                  <a
                    href={`/${loc.params.lang}/activities`}
                    class="bg-primary focus-visible:outline-primary rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2"
                  >
