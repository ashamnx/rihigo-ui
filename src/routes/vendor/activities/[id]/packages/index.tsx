                    ...
                    <div key={pkg.id} class="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                        <div class="card-body">
                            <div class="flex justify-between items-start mb-2">
                                <h3 class="card-title text-lg">{pkg.title || pkg.packageId}</h3>
                            ...
                            <p class="text-sm text-base-content/70 mb-3 line-clamp-2">{pkg.description}</p>
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div>
                                    ...
                                    <div class="text-xs text-base-content/60">ID: {pkg.packageId}</div>
                                </div>
                                <div class={`badge ${
                        ...
                        <Form action={savePackage} class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="form-control">
                                        <label class="label">
                                            <span class="label-text">Package ID <span class="text-error">*</span></span>
                                        </label>
                                        <input
                                            type="text"
                                            name="packageId"
                                    ...
                                    <div class="form-control">
                                        <label class="label">
                                            <span class="label-text">Package Title <span class="text-error">*</span></span>
                                        </label>
                                        <input
                                            type="text"
                                            name="title"
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline" onClick$={addPricingTier}>
                                        Add Tier
                                    </button>
                                </div>
                                        ...
                                        <div key={index} class="card bg-base-200">
                                            <div class="card-body p-4">
                                                <div class="flex justify-between items-center mb-4">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-error btn-outline" onClick$={() => removePricingTier(index)}>
                                                        Remove
                                                    </button>
                                                </div>
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div class="form-control">
                                                        <label class="label"><span class="label-text">Tier Name</span></label>
                                                        <input
                                                            type="text"
                                ...
                                {formData.pricingTiers!.length === 0 && (
                                    <div class="text-center py-4 border-2 border-dashed border-base-300 rounded">
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary mt-2" onClick$={addPricingTier}>
                                            Add First Tier
                                        </button>
                                    </div>
                                )}
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="form-control">
                                        <label class="label"><span class="label-text">Advance Booking Days</span></label>
                                        <input
                                            type="number"
                                    ...
                                    <div class="form-control">
                                        <label class="label"><span class="label-text">Max Bookings Per Day</span></label>
                                        <input
                                            type="number"
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center gap-2">
                    <input
                        type="text"
                        class="input input-bordered input-sm flex-1"
                        placeholder="Add time slot (e.g., 09:00)"
