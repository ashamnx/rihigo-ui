...
export const useCreateActivity = routeAction$(async (data, requestEvent) => {
    return authenticatedRequest(requestEvent, async (token) => {
        try {
            ...
            const response = await apiClient.vendorPortal.createActivity(activityInput, token);
            ...
            return {
                success: false,
                message: response.error_message || 'Failed to create activity'
            };
        } catch (error) {
            return {
                success: false,
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <Link href="/vendor/activities" class="btn btn-outline btn-sm sm:btn-md gap-2">
                ...
                <div class="alert alert-success mb-6 shadow-lg">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-sm mt-2 flex flex-wrap gap-3">
                            <Link href="/vendor/activities" class="link link-hover font-medium">
                                Return to activities list
                            </Link>
                            {createActivityAction.value.data?.id && (
                                <>
                                    <span class="opacity-50">|</span>
                                    <Link href={`/vendor/activities/${createActivityAction.value.data.id}`} class="link link-hover font-medium">
                                        Edit activity details
                                    </Link>
                                    <span class="opacity-50">|</span>
                                    <Link href={`/vendor/activities/${createActivityAction.value.data.id}/packages`} class="link link-hover font-medium">
                                        Add packages
                                    </Link>
                                </>
                            )}
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="form-control">
                                    ...
                                    <select name="category_id" class="select select-bordered focus:select-primary transition-all">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="form-control">
                                ...
                                <textarea
                                    ...
                                    placeholder="Experience the magic of sunset fishing in the Maldives..."
                                    required
                                    maxLength={160}
                                ...
                                <div class="collapse-content space-y-6">
                                    ...
                                    <div class="form-control">
                                        ...
                                        <input
                                            ...
                                            name="seo_keywords"
                                            class="input input-bordered focus:input-primary transition-all"
                                            placeholder="fishing, sunset, maldives, tour"
                                        />
                                        <label class="label">
...
export const head: DocumentHead = {
    title: "New Activity • Vendor Portal • Rihigo",
    meta: [
        {
            name: "description",
