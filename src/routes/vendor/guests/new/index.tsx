...
const guestSchema = z.object({
    ...
    gender: z.enum(['male', 'female', 'other']).or(z.literal('')).transform(v => v || undefined),
    preferred_language: z.string().optional(),
    id_type: z.enum(['passport', 'national_id', 'driver_license']).or(z.literal('')).transform(v => v || undefined),
